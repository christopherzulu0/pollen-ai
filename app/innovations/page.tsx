          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 text-center md:text-left">
              <div className="inline-block bg-white/10 backdrop-blur-xs px-4 py-2 rounded-full mb-6">
                <span className="text-[#00CC66] font-semibold">{copy.badge}</span>
              </div>
              <h1 className="text-4xl md:text-6xl font-bold tracking-tighter mb-6 text-white">
                {copy.title_prefix} <span className="text-[#00CC66]">{copy.title_highlight}</span> {copy.title_suffix}
              </h1>
                ...
                <div className="absolute inset-0 transform-style-3d rotate-y-12 rotate-x-12 animate-float-slow">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-white text-center p-6">
                      ...
                      <h3 className="text-2xl font-bold mb-2">{copy.next_gen}</h3>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tighter text-primary">{copy.timeline}</h2>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tighter text-primary">{copy.stack}</h2>
            <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
      ...
      <section className="py-16 md:py-24 bg-primary text-white">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tighter text-white">{copy.results}</h2>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tighter text-primary">{copy.in_action}</h2>
            <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tighter text-primary">{copy.how_it_works}</h2>
            <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
          ...
          <div className="bg-white p-8 rounded-xl shadow-xl max-w-4xl mx-auto">
            ...
            {showGlossary && (
              <div className="mt-8 bg-gray-50 rounded-lg p-6 border border-gray-200">
                <h3 className="text-xl font-bold text-primary mb-4">{copy.glossary}</h3>
              ...
              <div className="relative h-[300px] md:h-[400px] perspective-1000">
                <div className="absolute inset-0 transform-style-3d rotate-y-12 rotate-x-12 animate-float-slow">
                  ...
                  <div className="absolute inset-0 p-8 flex flex-col justify-between">
                    <div>
                      <h3 className="text-2xl font-bold mb-4">{copy.newsletter}</h3>
