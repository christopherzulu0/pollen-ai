          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter mb-6 leading-tight">
                {b.title_prefix} <span className="text-[#00CC66]">{b.title_highlight}</span> {b.title_suffix}
              </h1>
        ...
        <div className="container px-4 md:px-6 mx-auto">
          {isLoading ? (
            ...
            <div className="text-center py-16">
              ...
              <h3 className="text-xl font-semibold text-primary dark:text-white mb-2">{b.no_articles}</h3>
          ...
          <div className="mb-8 flex flex-col space-y-4">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div className="flex items-center space-x-2">
                <h2 className="text-2xl font-bold text-primary dark:text-white">{b.posts_heading}</h2>
                ...
                >
                  <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div className="space-y-2">
                      <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300">{b.category}</h3>
                      <Select value={categoryFilter} onValueChange={(value) => setCategoryFilter(value)}>
                        <SelectTrigger className="w-full bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 border-gray-200 dark:border-gray-700">
                          <SelectValue placeholder={b.select_category} className="text-gray-900 dark:text-gray-100" />
                        </SelectTrigger>
                    ...
                    {/* Tags Filter */}
                    <div className="space-y-2">
                      <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300">{b.tags}</h3>
                    ...
                    {/* Date Filter */}
                    <div className="space-y-2">
                      <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300">{b.date}</h3>
                      <Select value={dateFilter} onValueChange={(value) => setDateFilter(value)}>
                        <SelectTrigger className="w-full bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 border-gray-200 dark:border-gray-700">
                          <SelectValue placeholder={b.select_date} className="text-gray-900 dark:text-gray-100" />
                        </SelectTrigger>
                        <SelectContent className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300">{b.read_time}</h3>
          ...
          {activeTab === "all" && (
            <div className="mb-12">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-xl font-bold text-primary dark:text-white">{b.trending_now}</h3>
              </div>
        ...
        <div className="container px-4 md:px-6 mx-auto">
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold tracking-tighter mb-4">{b.newsletter_title}</h2>
