...
import { AvailabilityCalendar } from "@/components/support/calendar";
...
import type {
  ...
  BusyBlock,
  BookedBlock,
} from "@/components/support/calendar/types";
          ...
          <div className="mt-2 flex flex-wrap gap-x-4 gap-y-1 text-sm text-muted-foreground">
            {bookedBlocks.length > 0 && (
              <>
                ...
                <span className="flex items-center gap-1">
                  <span className="inline-block h-3 w-3 rounded bg-amber-500 dark:bg-amber-600" />
                  Tentative
                </span>
                <span className="flex items-center gap-1">
            ...
            {initialBusyBlocks.length > 0 && (
              <span className="flex items-center gap-1">
                <span className="inline-block h-3 w-3 rounded border border-destructive bg-destructive/20 dark:bg-destructive/30" />
                Busy (external)
              </span>
            )}
          </div>
