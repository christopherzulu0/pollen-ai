...
export default function JoinGroup() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-6 px-2 sm:px-4 mt-5">
      <Tabs defaultValue="code" onValueChange={(value) => setJoinMethod(value as "code" | "qr" | "discover")}>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
                  <Input
                    ...
                    className="font-mono w-full sm:flex-1 min-w-0"
                  />
                  <Button
              ...
              <div className="rounded-lg border border-border p-4">
                ...
                <ul className="space-y-2 pl-6 text-xs text-muted-foreground">
            ...
            <CardFooter className="border-t border-border bg-muted/50 p-4">
              <div className="flex w-full flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <p className="text-xs text-muted-foreground">Don't have a code? Try discovering public groups.</p>
                <Button
                  variant="ghost"
                  size="sm"
        ...
        <TabsContent value="qr" className="mt-6">
          <Card>
            ...
            <CardContent className="flex flex-col items-center justify-center space-y-4 p-4 sm:p-6">
              <div className="flex h-48 w-full max-w-64 sm:h-64 sm:w-64 items-center justify-center rounded-lg border-2 border-dashed border-border bg-muted/50">
                <div className="text-center">
                  <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-muted">
                    <QrCode className="h-6 w-6 text-muted-foreground" />
                  </div>
                  <p className="mb-2 text-sm font-medium">Camera Access Required</p>
                  <p className="text-xs text-muted-foreground">Click the button below to activate your camera</p>
            ...
            <CardFooter className="border-t border-border bg-muted/50 p-4">
              <div className="flex w-full flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <p className="text-xs text-muted-foreground">Don't have a QR code? Try entering a group code.</p>
                <Button
                  variant="ghost"
                  size="sm"
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              {filteredGroups.length === 0 ? (
                <div className="flex h-40 flex-col items-center justify-center rounded-lg border border-dashed border-border p-4">
                  <AlertCircle className="mb-2 h-8 w-8 text-muted-foreground" />
                  <p className="text-center text-sm font-medium">No groups found</p>
                  <p className="text-center text-xs text-muted-foreground">Try adjusting your search terms</p>
                </div>
              ) : (
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-1 md:grid-cols-2">
                  {filteredGroups.map((group) => (
                    <div
                      key={group.id}
                      className={`cursor-pointer rounded-lg border p-4 transition-all hover:border-primary hover:shadow-md ${selectedGroup === group.id ? "border-primary ring-1 ring-primary" : "border-border"}`}
            ...
            <>
              ...
              <div className="space-y-4 py-4">
                ...
                <div className="rounded-lg border border-warning/50 bg-warning/10 p-4">
                  <h3 className="mb-2 flex items-center gap-2 font-medium text-warning-foreground">
