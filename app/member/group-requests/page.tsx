...
export default function GroupRequestsPage() {
    ...
    // Defer Radix UI (Select, Tabs) rendering until after mount to avoid hydration mismatch
    useEffect(() => {
        setMounted(true)
    }, [])
    ...
    // Render skeleton during SSR and initial hydration to avoid Radix UI ID mismatch
    if (!mounted) {
        return (
                                    ...
                                    <div className="flex items-start justify-between">
                                        <div>
                                            ...
                                            <div className="flex items-center gap-1 mt-2">
                                                ...
                                                <span className="text-xs text-success">$28.5K</span>
                    ...
                    <div className="lg:col-span-2">
                        <Card className="bg-card border-border">
                            <CardHeader>
                                <div className="flex items-center justify-between">
                                    <div>
                                        <CardTitle className="text-foreground">{requestType === "loans" ? "Loan Requests" : "Join Requests"}</CardTitle>
