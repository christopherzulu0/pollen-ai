...
export function LoanRequestDetail({ request, onMutationSuccess }: LoanRequestDetailProps) {
    ...
    return (
        <div className="space-y-4">
                        ...
                        <>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div className={cn("p-3 rounded-lg", "bg-success/20 border border-success/50")}>
                                        <div className="flex items-center justify-between mb-1">
                                            <span className="text-xs font-medium text-success">Approve</span>
                                    ...
                                    <div className={cn("p-3 rounded-lg", "bg-destructive/20 border border-destructive/50")}>
                                        <div className="flex items-center justify-between mb-1">
                                ...
                                {request.votes.approve >= majorityNeeded ? (
                                    <div className="flex items-start gap-2 p-3 rounded-lg bg-success/20 border border-success/50">
                                        <CheckCircle2 className="h-4 w-4 text-success mt-0.5 shrink-0" />
                                        <div>
                                            <p className="text-sm font-medium text-success">✅ Majority approval reached!</p>
                                            <p className="text-xs text-muted-foreground mt-1">
                                    ...
                                    <div className="flex items-start gap-2 p-3 rounded-lg bg-destructive/20 border border-destructive/50">
            ...
            <Card className="bg-card border-border">
                <CardHeader>
                    <CardTitle className="text-sm text-foreground">Repayment Details</CardTitle>
                </CardHeader>
