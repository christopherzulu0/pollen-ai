...
const Widget = ({ onClose }: WidgetProps = {}) => {
  ...
  return (
    <div className="fixed bottom-24 right-6 z-50">
      {/* Widget Popup */}
      <div className="w-96 max-w-[calc(100vw-32px)] bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 overflow-hidden flex flex-col h-96">
        {/* Header */}
