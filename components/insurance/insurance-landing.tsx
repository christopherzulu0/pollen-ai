...
export function InsuranceLanding() {
  ...
  const benefits = [
    {
      icon: Users,
      title: copy.community_first,
      description: copy.community_first_desc,
    },
    {
      icon: TrendingUp,
      title: copy.affordable,
      description: copy.affordable_desc,
    },
    {
      icon: Lock,
      title: copy.secure,
      description: copy.secure_desc,
    },
  ]
  const steps = [
    { number: "01", title: copy.step1_title, description: copy.step1_desc },
    { number: "02", title: copy.step2_title, description: copy.step2_desc },
    { number: "03", title: copy.step3_title, description: copy.step3_desc },
    { number: "04", title: copy.step4_title, description: copy.step4_desc },
  ]
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
            <Button size="lg" className="text-base" asChild>
              <Link href="/kyc/submit">
                {copy.get_started} <ArrowRight className="ml-2 h-4 w-4" />
              </Link>
            </Button>
            <Button size="lg" variant="outline" className="text-base bg-transparent" asChild>
              <Link href="#products">{copy.explore_products}</Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      <section id="products" className="container mx-auto px-4 py-20 bg-muted/30">
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight">{copy.coverage_title}</h2>
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight">{copy.why_title}</h2>
          <p className="text-lg text-muted-foreground">
      ...
      <section className="container mx-auto px-4 py-20 bg-muted/30">
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight">{copy.how_title}</h2>
      ...
      <section className="container mx-auto px-4 py-20">
        <Card className="max-w-4xl mx-auto bg-primary text-primary-foreground">
          <CardContent className="p-12 text-center space-y-6">
            <h2 className="text-3xl md:text-4xl font-bold">{copy.cta_title}</h2>
      ...
      <footer className="border-t border-border bg-muted/30">
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="space-y-4">
              <h3 className="font-semibold text-lg">{copy.brand}</h3>
