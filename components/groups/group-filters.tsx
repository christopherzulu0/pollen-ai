  ...
  return (
    <div className="rounded-xl sm:rounded-2xl border border-border/50 bg-card/95 backdrop-blur-sm shadow-md p-4 sm:p-6 space-y-5 sm:space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-base sm:text-lg font-semibold text-foreground">{g.filters}</h2>
      ...
      <div className="space-y-3 sm:space-y-4">
        <Label className="text-xs sm:text-sm font-medium text-foreground">{g.privacy}</Label>
      ...
      <div className="space-y-3 sm:space-y-4">
        <Label className="text-xs sm:text-sm font-medium text-foreground">{g.status}</Label>
      ...
      <div className="space-y-3 sm:space-y-4">
        <Label className="text-xs sm:text-sm font-medium text-foreground">{g.frequency}</Label>
      ...
      <div className="space-y-2 sm:space-y-3">
        <div className="flex items-center justify-between">
          <Label className="text-xs sm:text-sm font-medium text-foreground">{g.contribution}</Label>
      ...
      <div className="space-y-2 sm:space-y-3">
        <div className="flex items-center justify-between">
          <Label className="text-xs sm:text-sm font-medium text-foreground">{g.interest_rate}</Label>
          <span className="text-[10px] sm:text-xs text-muted-foreground">
